...
Color termsCheckBox = const Color(0xffFCB13D);
Color loaderColor = const Color(0xff0042FF);
...
// New UI colors
List<Color> backgroundGradient = [Color(0xffFFFFFF), Color(0xff0042FF)];
Color white = Colors.white;
Color black = Colors.black;

// Dark Mode Colors
Color darkModeBackground = Color(0xff0D0D0D);
Color darkModeSecContainer = Color(0xff191B1A);
Color darkModeBorderColor = Color.fromARGB(30, 255, 255, 255);
Color darkModeDialogColor = Color(0xff0D0D0D);
Color darkModeSenderTextColor = Color.fromRGBO(0, 66, 255, 0.2);
