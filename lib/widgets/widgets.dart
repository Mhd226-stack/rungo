      ...
      child: Container(
        ...
        child: Container(
          ...
          padding: EdgeInsets.only(
              left: widget.leftPadding ?? media.width * twenty,
              right: widget.rightPadding ?? media.width * twenty),
          // decoration: BoxDecoration(
            ...
            child: Text(
              ...
              style: choosenLanguage == 'ar'
                  ...
                  : GoogleFonts.inter(
                      ...
                      color:
                          (widget.textcolor != null) ? widget.textcolor : white,
                ...
                children: [
                  (widget.image != null)
                    ...
                    color: textColor,
                      ...
                      : Icon(widget.icon,
                      size: media.width * twentythree, color: textColor),
                  SizedBox(
                    width: 10,
                  ),
                  SizedBox(
                    ...
                    child: Text(
                      ...
                      style: choosenLanguage == 'ar'
                          ...
                          : GoogleFonts.inter(
                          fontSize: media.width * sixteen, color: white),
                    ),
                  ),
                ],
              ),
