...
import 'package:flutter_user/pages/homePage/home_page.dart';
...
bool openDestinationOnLoad = false;
...
class _MapsState extends State<Maps>
  ...
  void _updateDriversStream(String lower, String higher) {
    if (_lastLower == lower && _lastHigher == higher) return;

    _lastLower = lower;
    _lastHigher = higher;

    // Assignation directe sans setState — safe dans build()
...
//get location permission and location details
  ...
  Widget build(BuildContext context) {
    ...
    // CORRECTION: lower/higher sont des String (geohash) — types corrects
    String lower = geo.encode(lowerLon, lowerLat);
    String higher = geo.encode(greaterLon, greaterLat);

    _updateDriversStream(lower, higher);
            ...
            builder: (context, value, child) {
              ...
              return Directionality(
                ...
                child: Scaffold(
                  ...
                  body: Stack(
                    children: [
                      // Bouton retour vers RungoHomePage
                      Positioned(
                              ...
                              (state == '1')
                                ...
                                children: [
                                  SizedBox(
                                      ...
                                      child: StreamBuilder<
                                          DatabaseEvent>(
                                        // CORRECTION: utilisation du stream stocké dans le State
