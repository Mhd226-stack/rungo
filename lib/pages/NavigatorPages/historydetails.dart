                          ...
                          Row(
                            ...
                            children: [
                              Icon(Icons.location_on_outlined,
                                  color: white, size: media.width * eighteen),
                              SizedBox(
                                width: media.width * 0.05,
                              ),
                              Expanded(
                              ...
                              Expanded(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      MyText(
                                        text:
                                            "${myHistory[selectedHistory]['driverDetail']['data']['car_model_name']}",
                                        size: media.width * fourteen,
                                        maxLines: 1,
                                        overflow: TextOverflow.ellipsis,
                                        color: textColor,
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            decoration: BoxDecoration(
                                                                                border: Border(
                                                                                    bottom: BorderSide(
                                                                              width: 1.1,
                                                                              color: (i == generalComplaintList.length - 1) ? Colors.transparent : white.withOpacity(0.3),
                                                                            ))),
                                                                            child:
                                                                                MyText(
